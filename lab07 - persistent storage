...
Create a PersistentVolume called host-storage-pv with a storage capacity of 1Gi in the acgk8s context. Configure this PersistentVolume so that volumes that use it can be expanded in the future.
...
/* --------------------------------- Action --------------------------------- */
<details><summary>Answer</summary> ```shell
# Create a PersistentVolume
